    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.question-options.update", [$questionOption->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('option_text') ? 'is-invalid' : '' }}" name="option_text" id="option_text" required>{{ old('option_text', $questionOption->option_text) }}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('correct') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="correct" id="correct" value="1" {{ $questionOption->correct || old('correct', 0) === 1 ? 'checked' : '' }}>
