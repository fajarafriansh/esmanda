<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
  ...
  <ul class="c-sidebar-nav">
    ...
    @can('courses_management_access')
      <li class="c-sidebar-nav-dropdown {{ request()->is("admin/courses*") ? "c-show" : "" }} {{ request()->is("admin/lessons*") ? "c-show" : "" }}">
        <a class="c-sidebar-nav-dropdown-toggle" href="#">
    ...
    @endcan
    @can('test_management_access')
      <li class="c-sidebar-nav-dropdown {{ request()->is("admin/tests*") ? "c-show" : "" }} {{ request()->is("admin/questions*") ? "c-show" : "" }} {{ request()->is("admin/question-options*") ? "c-show" : "" }}">
        <a class="c-sidebar-nav-dropdown-toggle" href="#">
          <i class="fa-fw fas fa-cogs c-sidebar-nav-icon"></i>
          {{ trans('cruds.testManagement.title') }}
        </a>
        <ul class="c-sidebar-nav-dropdown-items">
          @can('test_access')
            <li class="c-sidebar-nav-item">
          ...
          @can('question_access')
            <li class="c-sidebar-nav-item">
              <a href="{{ route("admin.questions.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/questions") || request()->is("admin/questions/*") ? "c-active" : "" }}">
                <i class="fa-fw fas fa-pen c-sidebar-nav-icon"></i>
          ...
          @can('question_option_access')
            <li class="c-sidebar-nav-item">
              <a href="{{ route("admin.question-options.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/question-options") || request()->is("admin/question-options/*") ? "c-active" : "" }}">
                <i class="fa-fw fas fa-list-ul c-sidebar-nav-icon"></i>
